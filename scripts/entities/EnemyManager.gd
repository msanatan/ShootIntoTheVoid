...
func handle_boss_sequence(level):
	if level % 5 == 0:
		...
		if level == 5:
			next_order = spawner_node.spawn_random_shielded_from_list(
				3, easy_shielded_enemy_list, true, 1
			)
			next_order = spawner_node.spawn_random_shielded_from_list(
				1, boss_shielded_enemy_list, true, next_order, 1000
			)
			...
			next_order = spawner_node.spawn_random_shielded_from_list(
				2, medium_shielded_enemy_list, true, next_order
			)
			next_order = spawner_node.spawn_random_shielded_from_list(
				1, boss_shielded_enemy_list, true, next_order, 1000
			)
			...
			next_order = spawner_node.spawn_random_shielded_from_list(
				3, medium_shielded_enemy_list, true, next_order
			)
			next_order = spawner_node.spawn_random_shielded_from_list(
				1, hard_shielded_enemy_list, true, next_order
			)
			next_order = spawner_node.spawn_random_shielded_from_list(
				1, boss_shielded_enemy_list, true, next_order, 1000
			)
			...
			next_order = spawner_node.spawn_random_shielded_from_list(
				4, easy_shielded_enemy_list, true, 1
			)
			next_order = spawner_node.spawn_random_shielded_from_list(
				2, medium_shielded_enemy_list, true, next_order
			)
			next_order = spawner_node.spawn_random_shielded_from_list(
				2, hard_shielded_enemy_list, true, next_order
			)
			next_order = spawner_node.spawn_random_shielded_from_list(
				1, boss_shielded_enemy_list, true, next_order, 1000
			)
			...
			next_order = spawner_node.spawn_random_shielded_from_list(
				3, hard_shielded_enemy_list, true, next_order
			)
			next_order = spawner_node.spawn_random_shielded_from_list(
				1, boss_shielded_enemy_list, true, next_order, 1000
			)
			...
			next_order = spawner_node.spawn_random_shielded_from_list(
				4, medium_shielded_enemy_list, true, next_order
			)
			next_order = spawner_node.spawn_random_shielded_from_list(
				3, hard_shielded_enemy_list, true, next_order
			)
			next_order = spawner_node.spawn_random_shielded_from_list(
				2, boss_shielded_enemy_list, true, next_order, 1000
			)
...
func spawn_objects_for_level(level):
	...
	if !is_boss_level:
		if level > 25:
			...
			next_order = spawner_node.spawn_random_shielded_from_list(
				2, easy_shielded_enemy_list, true, 1
			)
			next_order = spawner_node.spawn_random_shielded_from_list(
				3, medium_shielded_enemy_list, true, next_order
			)
